...
public class StripeService {
   ...
   * 
   * @param tokenParams The credit card details to obtain a token. These will never be stored in the
   *        DB
   * @param customerParams The parameters which identify the customer
   * @return The stripe customer id which can then be used to perform billing operations at a later
   *         stage
   * @throws com.devopsbuddy.exceptions.StripeException If an error occurred while interacting with
   *         Stripe
   */
